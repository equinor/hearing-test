...
import { Alert, Modal, SafeAreaView, StyleSheet, View, Animated } from 'react-native';
...
const SoundCheckPage = () => {
  ...
  function nextPage() {
    if (currentPage + 1 === pages.length) {
      navigate('SoundCheckFinishedRoute');
      setCurrentPage(0);
    } else {
      Animated.timing(opacityAnim, {
        toValue: 0,
  ...
  useEffect(() => {
    if (sound) {
      ...
      if (page.sound.play && !modalVisible) {
        ...
        setTimeout(() => playAudioTest(page.sound.ear), 1000 + ANIMATION_DURATION);
      }
    }
        ...
        <View style={styles.component}>
          ...
          >
            ...
            {page.button === 'variant1' ? (
              ...
              <CanHearSoundButton key={page.title} onPress={() => setTimeout(nextPage, 500)} />
            )}
